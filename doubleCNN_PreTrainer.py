...
class EarlyStopping:
    def __init__(self, patience=7, min_delta=0, path='cnn_tongue_expert.pth'):
...
if __name__ == "__main__":
    ...
    early_stopper = EarlyStopping(patience=7, path='cnn_tongue_expert.pth')
    ...
    print("\nStep 1 Complete. Tongue Expert saved as 'cnn_tongue_expert.pth'.")