...
IMAGE_PATH = r"C:\Users\User\Downloads\second_tongue.png"
MODEL_PATH = "TongueVision_Double_Transformer.pth"  # Ensure this file is in the same directory
...
class TongueVision(nn.Module):
    ...
    def forward(self, x):
        ...
        f_swin1 = f_swin1.permute(0, 3, 1, 2) # Permute for AGFF
        
        f_swin2 = self.branch2(x)['out']
        f_swin2 = f_swin2.permute(0, 3, 1, 2) # Permute for AGFF
...
def predict_single_image():
    ...
    # Save the figure
    save_path = "transformer_lime_result.png"
