...
# ==============================================================================
class EarlyStopping:
    def __init__(self, patience=7, min_delta=0, path='TongueVision_Diabetes_Final_v11.pth'):
...
if __name__ == "__main__":
    ...
    early_stopper = EarlyStopping(patience=7, path='TongueVision_Diabetes_Final_v11.pth')
    ...
    print("\nTraining Complete. Best model saved as 'TongueVision_Diabetes_Final_v11.pth'.")